...
For Job Seekers
    ...
    Browse available jobs on the Browse Jobs page
    Use filters to narrow down by location, type, experience, and salary
    Click Apply Now on any job listing
    Create an account or login with existing credentials
    Upload resume in My Profile
    Track all applications in the Applications section
    Save favorite jobs for later

For Employers

    Login to the Employer portal
    Navigate to Manage Jobs dashboard
    Click + Post New Job to create a listing
    Fill in job details, description, skills required, and salary
...
Setup Instructions
    ...
    Explore different features and sections
...
Created: November 2025 Version: 1.0
